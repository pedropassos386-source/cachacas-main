...
<head>
    ...
    <title>Cachaça Boralina | Novo Cruzeiro, MG</title>
    <meta name="description" content="Conheça a história, a produção e as características da Cachaça Boralina de Novo Cruzeiro, Minas Gerais.">
...
<body>
    ...
    <main id="conteudo-principal">
        <h1 class="product-title">Cachaça Boralina</h1>
        <div class="container">
            <div class="mini-imagens">
                ...
                <div class="cachacas-social">
                    <a class="instagram" href="https://www.instagram.com/cachacaboralina" target="_blank" rel="noopener noreferrer" aria-label="Instagram da Cachaça Boralina (abre em nova aba)">
